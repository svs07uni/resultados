...
class ci_mesas_superior extends toba_ci {
    ...
    function conf__cuadro(toba_ei_cuadro $cuadro) {
        ...
        $listas = $this->dep('datos')->tabla('lista_csuperior')->get_listas_actuales($claustro);
        ...
        $datos = $this->dep('datos')->tabla($this->nombre_tabla)->get_listado_votos('t_m.id_claustro=' . $claustro);
